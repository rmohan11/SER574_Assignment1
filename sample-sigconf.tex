...
There are certain architecture practices that help the architecture support the Agile process. These practices\cite{Eoin01} are derived from the Agile Manifesto\cite{Am01}. It also includes practices for the teams working together with others in collaboration such as:
